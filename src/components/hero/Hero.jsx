...
const Hero = () =>{
  ...
  >
    Piggyvest helps over 5 million customers achieve their financial goals by
    helping them save and invest with ease.
  </p>
</div>

                    {/* <div className="btns">
                        <button type="button" className="btnn"><img src="IMAGES/whiteAppleLogo.svg" style="height:22px; width:22px; margin-top: -2px;">Get on iPhone</button>
                        <button type="button" className="btnn"><img src="IMAGES/google-icon.svg" alt="">Get on Android</button>
                    </div> */}
                </div>
